...
for i = 1:length(functions)
    ...
    [result_pad, history_pad] = sos_pade(expr, x, y, x0, y0, r0, maxIter, tol, rf, eta);
    %[result_pad, history_pad] = trust_region_2d_plot(expr, x, y, x0, y0, r0, maxIter, tol, rf, eta);
    %[result_pad, history_pad] = trust_region_2d_naive(expr, x, y, x0, y0, r0, deg, maxIter, tol, method, rf, eta);
